...
declare class Player extends EventEmitter {
     ...
     */
    prepare(callback?: ((err: AudioError | null) => void)): this;
     ...
     */
    play(callback?: ((err: AudioError | null) => void)): this;
     ...
     */
    pause(callback?: ((err: AudioError | null) => void)): this;
     ...
     * or paused (`true`).
     */
    playPause(callback?: ((err: AudioError | null, paused: boolean) => void)): this;
     ...
     * @param callback 
     */
    stop(callback?: ((err: AudioError | null) => void)): this;
     ...
     * @param callback Callback is called after the operation has finished.
     */
    destroy(callback?: ((err: AudioError | null) => void)): void;
     ...
     */
    seek(position?: number, callback?: ((err: AudioError | null) => void)): void;
...
declare class Recorder extends EventEmitter {
     ...
     */
    prepare(callback?: ((err: AudioError | null, fsPath: string) => void)): this;
     ...
     */
    record(callback?: ((err: AudioError | null) => void)): this;
     ...
     * @param callback 
     */
    toggleRecord(callback?: ((err: AudioError | null) => void)): this;
